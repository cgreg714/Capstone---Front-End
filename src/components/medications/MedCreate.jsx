		...
		<React.Fragment>
			<Container style={styles.medContainer}>
				...
				<Form onSubmit={handleSubmit}>
					<Row className="row-cols-lg-auto align-items-center">
						<Col lg={8}>
							...
							<FormGroup row>
								...
								<Col sm={8}>
									<Input autoComplete="off" innerRef={medNameRef} placeholder="Medication Name" />
								</Col>
							</FormGroup>
							{/* Prescriber Input */}
							<FormGroup row>
								...
								<Col sm={8}>
									<Input autoComplete="off" innerRef={prescriberRef} placeholder="Prescriber Name" />
								</Col>
							</FormGroup>
							{/* Associated Drug Input */}
							<FormGroup row>
								<Label sm={4}>
									<h3>Associated Drug</h3>
								</Label>
								<Col sm={8}>
									<InputGroup>
						...
						<Col lg={4}>
							...
							<FormGroup tag="fieldset">
								...
								{frequencyArray.map((f, i) => (
									<FormGroup check key={i} style={{ display: 'inline-block' }}>
										<Input name="radio1" type="radio" innerRef={frequencyInnerRefArray[i]} />
										<Label check>{f}</Label>
									</FormGroup>
								))}
							</FormGroup>
					...
					<Button color="success" style={{ width: '75%' }}>
						Add Medication
					</Button>
				</Form>
			</Container>
